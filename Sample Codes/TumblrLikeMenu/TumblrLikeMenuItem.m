               ...
               text:(NSString *)text
{
    ...
    if (self)
    {
        ...
        //自己调整过lable位置
        self.menuLabel = [[UILabel alloc] initWithFrame:CGRectMake(-8, self.image.size.height + 5, self.frame.size.width + 18, 18)];
        self.menuLabel.textColor = [UIColor whiteColor];
        self.menuLabel.font = [UIFont systemFontOfSize:12];
