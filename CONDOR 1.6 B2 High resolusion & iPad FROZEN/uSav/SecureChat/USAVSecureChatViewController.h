...
@interface USAVSecureChatViewController : UIViewController <UITableViewDataSource, UITableViewDelegate, UITextViewDelegate, UIDocumentInteractionControllerDelegate, MFMailComposeViewControllerDelegate, TimeArrangeDelegate>

@property (strong, nonatomic) USAVSecureChatListTableViewController *chatListDelegate;
@property (nonatomic, weak) id <TimeArrangeDelegate> delegateOfRestrictions;
...
@property (strong, nonatomic) NSMutableArray *timerList;
