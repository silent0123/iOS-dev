...
- (void)passDuration:(NSInteger)duration {
    ...
    if (self.allowSaveDecryptCopy || (self.Tf_Duration == 0 && [self.Tf_NumLimit.text integerValue] == 0)) {
        ...
        NSString *titleOfRestriction = [NSString stringWithFormat:NSLocalizedString(@"Viewing Restrictions: %zi times | %zi seconds", nil), [self.Tf_NumLimit.text integerValue], self.Tf_Duration];
        
        if ([[NSUserDefaults standardUserDefaults] integerForKey:@"DefaultLimit"] == 0 && [[NSUserDefaults standardUserDefaults] integerForKey:@"DefaultDuration"] != 0) {
            
            titleOfRestriction = [NSString stringWithFormat:NSLocalizedString(@"Viewing Restrictions: unlimit times | %zi seconds", nil), self.Tf_Duration];
            
        } else if ([[NSUserDefaults standardUserDefaults] integerForKey:@"DefaultLimit"] != 0 && [[NSUserDefaults standardUserDefaults] integerForKey:@"DefaultDuration"] == 0) {
            
            titleOfRestriction = [NSString stringWithFormat:NSLocalizedString(@"Viewing Restrictions: %zi times | unlimit seconds", nil), [self.Tf_NumLimit.text integerValue]];
        }
...
//    self.tokenField.textField.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleBottomMargin;
  ...
  // Configure search table
    ...
    butTimeArrange.frame = CGRectMake(0, 10, CGRectGetWidth(viewBounds), 40);
...
//    butTimeArrange.layer.borderWidth = 1.2;
    ...
    butUsavContact.frame = CGRectMake(0, 66, CGRectGetWidth(viewBounds), 40);
    butUsavContact.backgroundColor = [UIColor colorWithWhite:0.2 alpha:1];
    ...
    butAddBook.frame = CGRectMake(0, 122, CGRectGetWidth(viewBounds), 40);
    ...
    butShare.frame = CGRectMake(0, 178, CGRectGetWidth(viewBounds), 40);
    ...
    self.DoneBtn.frame = CGRectMake(0, 234, CGRectGetWidth(viewBounds), 40);
