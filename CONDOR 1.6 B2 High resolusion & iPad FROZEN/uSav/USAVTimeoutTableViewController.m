...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem.title = NSLocalizedString(@"DoneKey", nil);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (section == 0) {
        ...
        cell.textLabel.text = [NSLocalizedString(@"Force Logout After ", nil) stringByAppendingString:[NSString stringWithFormat:NSLocalizedString(@"%.0f (min)", nil), self.timeInterval]];
        cell.textLabel.font = [UIFont boldSystemFontOfSize:13];
