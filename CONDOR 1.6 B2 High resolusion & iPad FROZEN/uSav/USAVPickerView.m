...
- (id)initWithFrame:(CGRect)frame withGroupList:(NSArray *)list forContact:(NSDictionary *)contact
{
    ...
    if (self) {
        ...
        UIPickerView *myPickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(0, 100, [[UIScreen mainScreen] bounds].size.width, 400)];
...
- (NSAttributedString *)pickerView:(UIPickerView *)pickerView attributedTitleForRow:(NSInteger)row forComponent:(NSInteger)component {
    ...
    NSDictionary *stringAttribute = [[NSDictionary alloc] initWithObjectsAndKeys:[UIColor whiteColor], NSForegroundColorAttributeName, [UIFont boldSystemFontOfSize:13], NSFontAttributeName, nil];
