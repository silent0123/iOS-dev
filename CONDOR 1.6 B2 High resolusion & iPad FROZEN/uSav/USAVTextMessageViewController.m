...
- (void)viewDidLoad {
    ...
    //提示
    self.progressLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 4, [[UIScreen mainScreen] bounds].size.width, self.progressView.frame.size.height + 12)];
...
- (void)keyboardWillHide:(NSNotification *)notification {
    ...
    keyboardIsShowed = NO;
    NSLog(@"Hide keyboard");
    self.messageTextView.frame = CGRectMake(0, 20, [[UIScreen mainScreen] bounds].size.width, 504);
    previousHeight = 504;
