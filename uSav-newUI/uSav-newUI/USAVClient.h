...
#define URL_PREFIX @"https://webapi.usav-nwstor.com/api"  //对外接口
//#define URL_PREFIX @"http://nwstortestweb.azurewebsites.net/api"
//#define URL_PREFIX @"http://int.usav-nwstor.com:8081/api"   //内部测试
...
- (id) getSize:(NSString *)text FontName:(NSString *)f_name FontSize:(float)f_size LabelWidth:(int)labelWidth label:(UILabel *)templbl;
-(void)startProgress;
-(void)stopProgress;
-(void)playClick;
