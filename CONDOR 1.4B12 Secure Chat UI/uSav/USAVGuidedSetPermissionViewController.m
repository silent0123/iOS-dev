...
//    self.navigationController.navigationBar.topItem.leftBarButtonItem = leftBarBtn;
    
    //[self.navigationController.navigationBar.topItem setTitle:NSLocalizedString(@"ContactListLabel", @"")];
