...
#warning Potentially incomplete method implementation.
    ...
    self.navigationController.navigationBar.topItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"icon_back_blue"] style:UIBarButtonItemStylePlain
                                                                                                        target:self
                                                                                                        action:@selector(cancelButtonPressed:)];
    self.navigationController.navigationBar.topItem.leftBarButtonItem.tintColor = [UIColor colorWithRed:(20.0/255.0) green:(124.0/255.0) blue:(255.0/255.0) alpha:1];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        case 0:cell.textLabel.text = NSLocalizedString(@"Always", @""); break;
