...
- (BOOL)encryptFile:(NSString *)originalFilepath targetFile:(NSString *)filePath keyID:(NSData *)keyId keyContent:(NSData *)keyContent withExtension:(NSString *)ext andMinversion:(NSInteger)version
{
