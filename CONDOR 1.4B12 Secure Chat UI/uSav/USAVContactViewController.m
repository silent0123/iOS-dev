...
//
//
// [self.navigationController.navigationBar.topItem setTitle:NSLocalizedString(@"ContactHomeTitleKey", @"")];
...
-(void) listGroupMemberResult:(NSDictionary*)obj {
	...
	if ((obj != nil) && ([obj objectForKey:@"memberList"] != nil)) {
        ...
        // update the title
        [self.navigationController.navigationBar.topItem setTitle:[NSString stringWithFormat:@"%@", [self getCurrentLayer]]];
        //self.navigationController.navigationBar.topItem.leftBarButtonItem = self.homeBtn;
        // [self.tblView reloadData];
...
- (void)viewDidLoad
{
    ...
    self.hintLabel.text = NSLocalizedString(@"No Contact", nil);
    ...
    self.navigationController.navigationBar.topItem.rightBarButtonItem = self.actionBarBtn;
    self.navigationController.navigationBar.topItem.leftBarButtonItem = self.homeBtn;
    ...
    //self.navigationController.navigationBar.topItem.rightBarButtonItem = self.homeBtn;
    ...
    if (self.mode == CONTACT_VIEW_MODE_SELECT) {
        ...
        self.navigationController.navigationBar.topItem.leftBarButtonItem = self.selectDoneBtn;
    }
...
-(void)deleteGroupOrContact {
    ...
    self.navigationController.navigationBar.topItem.rightBarButtonItem = self.doneBarBtn;
...
-(void)addGroupBtnPressed {
    ...
    UIImageView *myView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"group3.png"]];
...
{
    [self.navigationController.navigationBar.topItem setTitle:NSLocalizedString(@"AddContactToGroupTitleKey", @"")];
    ...
    self.pickerView = [[USAVPickerView alloc] initWithFrame:CGRectMake(-320.0f, 64.0f, 320.0f, screenHeight - 64) withGroupList:self.arrayOfGroups forContact:[self.arrayOfContacts objectAtIndex:currentContactIndex]];
    
    self.pickerView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"Inner_bg_lightgray"]];
    ...
    // self.navigationController.navigationBar.topItem.leftBarButtonItem = self.actionBarBtn;
    ...
    [UIView animateWithDuration:0.2 // 0.2 but slowed down to easily see difference
                     ...
                     animations:^{
                         ...
                         [self.pickerView setFrame:CGRectMake(0.0f, 0.0f, 320.0f, screenHeight)];
                         // [self.dimView setFrame:CGRectMake(0.0f, 0.0f, 320.0f, 50.0f)];
                     }
...
-(void)pickerViewSaveCmd:(NSString *)groupStr forContact:(NSDictionary *)contactDict target:(USAVPickerView *)sender
{
    ...
    [UIView animateWithDuration:0.2 // 0.2 but slowed down to easily see difference
                     ...
                     animations:^{
                         ...
                         [self.tblView reloadData];
                         [self.pickerView setFrame:CGRectMake( -320.0f, 0.0f, 320.0f, 420.0f)];
