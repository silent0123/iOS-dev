...
{
    //return [UIColor colorWithRed:0.0/255.0 green:109.0/255.0 blue:177.0/255.0 alpha:1.0];
    //return [UIColor colorWithRed:46.0/255.0 green:162.0/255.0 blue:204.0/255.0 alpha:1.0];
    return [UIColor colorWithRed:45.0/255.0 green:160.0/255.0 blue:231.0/255.0 alpha:1.0];
}
...
+ (NSDictionary *)titleAttributesWithColor:(UIColor *)color {
    ...
    NSDictionary *attributes = @{NSFontAttributeName: [Utility titleFont],
