...
- (void)passDuration:(NSInteger)duration {
    ...
    if (self.allowSaveDecryptCopy || (self.Tf_Duration == 0 && [self.Tf_NumLimit.text integerValue] == 0)) {
        [self.timeArrangeButton setTitle:@"Viewing Restrictions: No Limit" forState:UIControlStateNormal];
    } else {
        [self.timeArrangeButton setTitle:[NSString stringWithFormat:@"Viewing Restrictions: %zi times | %zi seconds", [self.Tf_NumLimit.text integerValue], self.Tf_Duration] forState:UIControlStateNormal];
    }
}
...
- (void)sendNotificationWithDelay {

    [[NSNotificationCenter defaultCenter] postNotificationName:@"TextPermissionReady" object:nil];
}
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    [self.navigationController.navigationBar.topItem setTitle:NSLocalizedString(@"EditPermissionTitleBar", "")];
}
...
//    self.tokenField.textField.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleBottomMargin;
  ...
  // Configure search table
    ...
    //No limit 或者Allowcopy状态按钮提示修改
    if (self.allowSaveDecryptCopy || (self.Tf_Duration == 0 && [self.Tf_NumLimit.text integerValue] == 0)) {
        [butTimeArrange setTitle:@"Viewing Restrictions: No Limit" forState:UIControlStateNormal];
    } else {
        [butTimeArrange setTitle:[NSString stringWithFormat:@"Viewing Restrictions: %zi times | %zi seconds", [self.Tf_NumLimit.text integerValue], self.Tf_Duration] forState:UIControlStateNormal];
    }

    butTimeArrange.frame = CGRectMake(0, 10, CGRectGetWidth(viewBounds), 38);
    [butTimeArrange.titleLabel setFont:[UIFont boldSystemFontOfSize:14]];
    [butTimeArrange  setContentHorizontalAlignment:UIControlContentHorizontalAlignmentLeft];
    ...
    [butTimeArrange setTitleEdgeInsets:UIEdgeInsetsMake(0.0f, 10.0f, 0.0f, -5.0f)];
    ...
    [butUsavContact.titleLabel setFont:[UIFont boldSystemFontOfSize:14]];
    butUsavContact.backgroundColor = [UIColor colorWithWhite:0.2 alpha:1];
    butUsavContact.frame = CGRectMake(0, 60, CGRectGetWidth(viewBounds), 38);
    butUsavContact.backgroundColor = [UIColor colorWithWhite:0.2 alpha:1];
    [butUsavContact  setContentHorizontalAlignment:UIControlContentHorizontalAlignmentLeft];
    [butUsavContact  setContentVerticalAlignment:UIControlContentVerticalAlignmentCenter];
    //move text 10 pixels down and right
    [butUsavContact setTitleEdgeInsets:UIEdgeInsetsMake(0.0f, 10.0f, 0.0f, -5.0f)];
    ...
    butAddBook.frame = CGRectMake(0, 110, CGRectGetWidth(viewBounds), 38);
    [butAddBook.titleLabel setFont:[UIFont boldSystemFontOfSize:14]];
    [butAddBook  setContentHorizontalAlignment:UIControlContentHorizontalAlignmentLeft];
    [butAddBook  setContentVerticalAlignment:UIControlContentVerticalAlignmentCenter];
    //move text 10 pixels down and right
    [butAddBook setTitleEdgeInsets:UIEdgeInsetsMake(0.0f, 10.0f, 0.0f, -5.0f)];
    ...
    [butShare.titleLabel setFont:[UIFont boldSystemFontOfSize:14]];
    butShare.frame = CGRectMake(0, 160, CGRectGetWidth(viewBounds), 38);
    [butShare  setContentHorizontalAlignment:UIControlContentHorizontalAlignmentLeft];
    ...
    //move text 10 pixels down and right
    [butShare setTitleEdgeInsets:UIEdgeInsetsMake(0.0f, 10.0f, 0.0f, -5.0f)];
    ...
    [self.DoneBtn.titleLabel setFont:[UIFont boldSystemFontOfSize:14]];
    ...
    self.DoneBtn.frame = CGRectMake(0, 210, CGRectGetWidth(viewBounds), 38);
    [self.DoneBtn  setContentHorizontalAlignment:UIControlContentHorizontalAlignmentLeft];
    [self.DoneBtn  setContentVerticalAlignment:UIControlContentVerticalAlignmentCenter];
    //move text 10 pixels down and right
    [self.DoneBtn setTitleEdgeInsets:UIEdgeInsetsMake(0.0f, 10.0f, 0.0f, -5.0f)];
    ...
    NSString *filenameDisplay = [NSString stringWithFormat:@"Filename: %@", self.fileName];
